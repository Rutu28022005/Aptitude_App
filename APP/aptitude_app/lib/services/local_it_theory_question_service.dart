...
class LocalITTheoryQuestionService {
  static const String _assetPath = 'assets/it_theory_mcqs.json';
  ...
  Future<List<Map<String, dynamic>>> _loadJson() async {
    ...
    try {
      ...
      throw Exception('Failed to load IT theory questions from $_assetPath: $e');
    }
  }
    ...
    for (int i = 0; i < take; i++) {
      ...
      questions.add(
        Question(
          ...
          questionHash: 'local_it_theory_${raw['id']}',
          generatedAt: now,
