...
class LocalVerbalAbilityQuestionService {
  static const String _assetPath = 'assets/verbal_ability_mcqs.json';
  ...
  Future<List<Map<String, dynamic>>> _loadJson() async {
    ...
    try {
      ...
      throw Exception('Failed to load verbal ability questions from $_assetPath: $e');
    }
  }
